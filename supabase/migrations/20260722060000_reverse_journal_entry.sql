-- Legacy Core ERP
-- Add journal reversal support: two linking columns and a reversal function.
...
begin
  ...
  insert into public.entries (
    ...
    contractor_name, payment_method, amount, project_id, created_by
  )
  values (
    current_date,
    v_journal.entry_type,
    v_journal.category,
    'عكس: ' || v_journal.entry_description,
  ...
  values (
    current_date,
    'عكس: ' || v_journal.journal_description,
    'posted',
