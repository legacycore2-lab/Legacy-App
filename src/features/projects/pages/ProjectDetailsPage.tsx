...
export function ProjectDetailsPage() {
  ...
  const progressStyle = { '--project-progress': `${progress * 3.6}deg` } as React.CSSProperties
      ...
      <div className="project-v2-hero">
        <div className="project-v2-hero__content">
          ...
          <div className="project-v2-actions">
            ...
            <button type="button" className="project-v2-action project-v2-action--primary" onClick={() => navigate('/journal')}>
              <Plus size={17} />
              إضافة قيد
            </button>
          </div>
      ...
      <div className="project-v2-layout">
        <div className="project-v2-main">
          ...
          <article className="project-v2-card project-v2-entries">
            ...
            {entries.length === 0 ? (
              <div className="project-v2-empty"><BriefcaseBusiness size={26} /><p>لا توجد قيود مرتبطة بهذا المشروع.</p></div>
            ) : (
