      ...
      >
        <header>
          <div>
            ...
            <h2 id="deposit-title">تسجيل إيداع</h2>
            <p>سيُنشأ قيد يومية متوازن ويُرحّل مع حركة الإيداع في عملية واحدة.</p>
          </div>
        ...
        >
          <div className="cash-bank-dialog-grid">
            <label>
              ...
              >
                ...
                {form.destinationAccounts.map((account) => (
          ...
          <footer>
            ...
            <button type="submit" className="cash-banks-primary" disabled={form.isSaving}>
              ...
              {form.isSaving ? 'جارٍ الترحيل...' : 'ترحيل الإيداع'}
            </button>
          </footer>
        </form>
      </section>
