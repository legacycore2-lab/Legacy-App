    ...
    <section className="projects-page">
      <header className="projects-hero">
        <div>
          ...
          <h1>المشاريع</h1>
          <p>متابعة التنفيذ، التدفقات المالية، ونسب الإنجاز من مكان واحد.</p>
        </div>
        <div className="projects-hero__actions">
          <button className="projects-secondary-action" type="button">استيراد المشاريع</button>
          <button className="projects-primary-action" type="button"><Plus size={18} /> مشروع جديد</button>
        </div>
      </header>
      ...
      <div className="projects-section-heading">
        <div><span>المحفظة الحالية</span><h2>كل المشاريع</h2></div>
